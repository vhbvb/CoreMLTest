...
SWIFT_MODULE_NAMESPACE_PUSH("CoreMLTest")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC10CoreMLTest11AppDelegate")
...
SWIFT_CLASS("_TtC10CoreMLTest14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(CoreMLTest)) <AVCaptureVideoDataOutputSampleBufferDelegate>
